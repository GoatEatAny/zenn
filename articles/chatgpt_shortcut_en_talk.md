...
3. ショートカットを実行（必要に応じて、各種アクセスを許可）
 ...
 ![image1](../images/chatgpt_shortcut_en_talk/img01.PNG)
 *英語能力レベル選択フォーム*
...
![image6](../images/chatgpt_shortcut_en_talk/img08.png)
